...
//   popUpElements:
    ...
    public WebElement popupEnterButton = $(By.cssSelector(".submit.enter_btn"));
...
//    Images???
    ...
    public void checkPopupRememberMeCheckBoxNotSelected(){
        $(popupRememberMeCheckBox).shouldBe(visible).shouldNotBe(selected);
    }
    public void checkPopupRememberMeCheckBoxSelected(){
        $(popupRememberMeCheckBox).shouldBe(visible).shouldBe(selected);
    }
    ...
    public void checkPopupWrongEmailOrPasswordLabelIsPresent(){
        $(popupForgotPasswordWrongEmailLabel).shouldBe(visible).shouldHave(text(popupWrongEmailOrPasswordLabelText));
    }
    ...
    public void checkPopupForgotPasswordWrongEmailLabel(){
    ...
    public void checkCheckAtestatLink(){
        $(checkAtestatLink).shouldBe(visible).shouldHave(text(checkAtestatLinkText));
    }

...
//    Images???
    ...
    @Test
    public void assertPopupRememberMeCheckBoxNotSelected() {
        clickOnEnterAndRegButton();
        checkPopupRememberMeCheckBoxNotSelected();
        System.out.println("Test: assertPopupRememberMeCheckBoxNotSelected - PASSED");
    }
    @Test
    public void assertPopupRememberMeCheckBoxSelected() {
        clickOnEnterAndRegButton();
        clickPopupRememberMeCheckBox();
        checkPopupRememberMeCheckBoxSelected();
        System.out.println("Test: assertPopupRememberMeCheckBoxSelected - PASSED");
    }
    @Test
    ...
    public void assertPopupForgotPasswordWrongEmailLabel() {
        clickOnEnterAndRegButton();
        clickOnPopupForgotPasswordLink();
        checkPopupForgotPasswordWrongEmailLabel();
        System.out.println("Test: assertPopupForgotPasswordRestoreButton - PASSED");
    }
